# Script to combine all band images from folder and generate large images by stacking up 12 band images each.
# credits: Mostly chatGPT :)
...
for i, file in enumerate(png_files):
    ...
    if len(images) == max_images or i == len(png_files) - 1:
        ...
        output_file_path = os.path.join(output_folder, output_file_template.format(i // max_images + 1))
